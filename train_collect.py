...
def parse_args():
    ...
    parser.add_argument('--amlt', default=False, action='store_true')
...
def main():
    ...
    if args.load_model_from:
        agent.load(args.load_model_from, args.load_model_step)
        print("Loaded from", args.load_model_from, args.load_model_step)
    if args.load_buffer_from:
        replay_buffer.load(args.load_buffer_from)
        
    if args.test:
        test(env, agent, args.num_eval_episodes)
        return
